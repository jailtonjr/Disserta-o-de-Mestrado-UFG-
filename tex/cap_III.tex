...
\label{tab:4.1}
  \scalebox{0.75}{
    ...
    \hline
    \multicolumn{1}{|c|}{AET – Automação da Execução do Teste} & AET3 – Definir um \textit{framework} para automação de teste & \multicolumn{1}{c|}{Sim} \\ 
    \cline{2-3}
...
\label{tab:4.2}
  \scalebox{0.75}{
    ...
    \cline{2-3}
    \multicolumn{1}{|c|}{} & Manter \textit{script} de regressão (TRG2) & \multicolumn{1}{c|}{Não} \\ 
    \cline{2-3}
    ...
    \cline{2-3}
    \multicolumn{1}{|c|}{} & Elaborar \textit{script} BDD (INC2) & \multicolumn{1}{c|}{Não} \\ 
    \cline{2-3}
    \multicolumn{1}{|c|}{} & Montar \textit{build} (INC3) & \multicolumn{1}{c|}{Não} \\ 
    \hline
    \multicolumn{1}{|c|}{Teste de desempenho} & Preparar massa de teste (TPE1) & \multicolumn{1}{c|}{Não} \\ 
    \cline{2-3}
    \multicolumn{1}{|c|}{} & Manter \textit{script} de desempenho (TPE2) & \multicolumn{1}{c|}{Não} \\ 
    \cline{2-3}

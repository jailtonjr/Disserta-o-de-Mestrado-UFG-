...
%Construção do Framework de processo
...
\begin{table}[!ht]
\centering
\caption{Equivalência entre MPT.Br e FreeTest.}
\label{tab:4.1}
  \scalebox{0.75}{
    \begin{tabular}{|l|l|l|}
    \hline
    \multicolumn{2}{|c|}{MPT.Br} & \multicolumn{1}{c|}{FreeTest} \\ 
    \hline
    \multicolumn{1}{|c|}{Área de Processo} & \multicolumn{1}{c|}{Práticas Especificas} & \multicolumn{1}{c|}{Equivalente?} \\ 
    \hline
    \multicolumn{1}{|c|}{GPT – Gerência de Projetos de Teste} & GPT11 – Planejar o ambiente de teste para o projeto & \multicolumn{1}{c|}{Sim} \\ 
    \hline
    \multicolumn{1}{|c|}{PET – Projeto e Execução de Teste} & PET2 – Executar casos de teste & \multicolumn{1}{c|}{Sim} \\ 
    \cline{2-3}
    \multicolumn{1}{|c|}{} & PET3 – Reportar incidentes & \multicolumn{1}{c|}{Sim} \\ 
    \cline{2-3}
    \multicolumn{1}{|c|}{} & PET4 – Acompanhar incidentes & \multicolumn{1}{c|}{Sim} \\ 
    \hline
    \multicolumn{1}{|c|}{FDT – Fechamento do Teste} & FDT4 – Consolidar dados de teste & \multicolumn{1}{c|}{Sim} \\ 
    \hline
    \multicolumn{1}{|c|}{TDA – Teste de Aceitação} & TDA5 – Preparar ambiente para aceitação & \multicolumn{1}{c|}{Sim} \\ 
    \cline{2-3}
    \multicolumn{1}{|c|}{} & TDA6 – Conduzir testes de aceitação & \multicolumn{1}{c|}{Sim} \\ 
    \cline{2-3}
    \multicolumn{1}{|c|}{} & TDA7 – Avaliar condições de aceitação & \multicolumn{1}{c|}{Sim} \\ 
    \hline
    \multicolumn{1}{|c|}{TES – Teste Estático} & TES1 – Identificar produtos de trabalho e tipos de revisão & \multicolumn{1}{c|}{Sim} \\ 
    \cline{2-3}
    \multicolumn{1}{|c|}{} & TES2 – Definir critérios de revisões & \multicolumn{1}{c|}{Sim} \\ 
    \cline{2-3}
    \multicolumn{1}{|c|}{} & TES3 – Conduzir revisões & \multicolumn{1}{c|}{Sim} \\ 
    \cline{2-3}
    \multicolumn{1}{|c|}{} & TES4 – Analisar dados de revisões & \multicolumn{1}{c|}{Sim} \\ 
    \hline
    \multicolumn{1}{|c|}{AET – Automação da Execução do Teste} & AET3 – Definir um framework para automação de teste & \multicolumn{1}{c|}{Sim} \\ 
    \cline{2-3}
     & AET4 – Gerenciar incidentes de teste automatizado & \multicolumn{1}{c|}{Sim} \\ 
    \hline
    \end{tabular}
}
\end{table}
...
\begin{table}[!ht]
\centering
\caption{Práticas especificas do Método FreeTest que NÃO possuem equivalência com o MPT.Br.}
\label{tab:4.2}
  \scalebox{0.75}{
    \begin{tabular}{|l|l|l|}
    \hline
    ...
    \multicolumn{1}{|c|}{Área de Processo} & \multicolumn{1}{c|}{Práticas Especificas} & \multicolumn{1}{c|}{Equivalente?} \\ 
    \hline
    \multicolumn{1}{|c|}{Teste de regressão} & Preparar massa de teste (TRG1) & \multicolumn{1}{c|}{Não} \\ 
    \cline{2-3}
    \multicolumn{1}{|c|}{} & Manter script de regressão (TRG2) & \multicolumn{1}{c|}{Não} \\ 
    \cline{2-3}
    \multicolumn{1}{|c|}{} & Executar teste de regressão (TRG3) & \multicolumn{1}{c|}{Não} \\ 
    \cline{2-3}
    \multicolumn{1}{|c|}{} & Encerrar teste de regressão (TRG4) & \multicolumn{1}{c|}{Não} \\ 
    \hline
    \multicolumn{1}{|c|}{Integração contínua} & Elaborar código (INC1) & \multicolumn{1}{c|}{Não} \\ 
    \cline{2-3}
    \multicolumn{1}{|c|}{} & Elaborar script BDD (INC2) & \multicolumn{1}{c|}{Não} \\ 
    \cline{2-3}
    \multicolumn{1}{|c|}{} & Montar build (INC3) & \multicolumn{1}{c|}{Não} \\ 
    \hline
    \multicolumn{1}{|c|}{Teste de desempenho} & Preparar massa de teste (TPE1) & \multicolumn{1}{c|}{Não} \\ 
    \cline{2-3}
    \multicolumn{1}{|c|}{} & Manter script de desempenho (TPE2) & \multicolumn{1}{c|}{Não} \\ 
    \cline{2-3}
    \multicolumn{1}{|c|}{} & Executar teste de desempenho (TPE3) & \multicolumn{1}{c|}{Não} \\ 
    \cline{2-3}
    \multicolumn{1}{|c|}{} & Encerrar teste de desempenho (TPE4) & \multicolumn{1}{c|}{Não} \\ 
    \hline
    \end{tabular}
}
\end{table}

Como observados na tabela \ref{tab:4.2} somente as práticas especificas do Método FreeTest que não possuem quaisquer equivalências com as práticas especificas do MPT.Br foram ressaltadas. Na tabela \ref{tab:4.1} as práticas especificas do MPT.Br que possuem equivalência com o FreeTest foram listadas, a intenção é que somente as práticas especificas do MPT.Br que não forem listadas sejam possíveis contribuições de melhoria ao novo processo proposto neste trabalho.
...
\begin{table}[!ht]
\centering
\caption{Sugestões de Melhoria para o novo processo a partir do MPT.Br}
\label{tab:4.3}
\scalebox{0.75}{
    \begin{tabular}{|l|l|l|}
    \hline
    ...
    \cline{2-3}
    \multicolumn{1}{|c|}{} & TES3 – Conduzir revisões & \multicolumn{1}{c|}{Mantido} \\ 
    \cline{2-3}
    \multicolumn{1}{|c|}{} & TES4 – Analisar dados de revisões & \multicolumn{1}{c|}{Mantido} \\ 
    \hline
    \multicolumn{1}{|c|}{AET} & AET3 – Definir um framework para automação de teste & \multicolumn{1}{c|}{Mantido} \\ 
    \cline{2-3}
    \multicolumn{1}{|c|}{} & AET4 – Gerenciar incidentes de teste automatizado & \multicolumn{1}{c|}{Mantido} \\ 
    \hline
    \end{tabular}
}
\end{table}
...
\begin{table}[!ht]
\centering
\caption{Melhorias promovidas para o novo processo nas práticas do FreeTest}
\label{tab:4.4}
  \scalebox{0.75}{
    \begin{tabular}{|l|l|l|}
    \hline
    \multicolumn{1}{|c|}{Área de Processo} & \multicolumn{1}{c|}{Prática Especifica} & \multicolumn{1}{c|}{Ação} \\ 
    \hline
    \multicolumn{1}{|c|}{Teste de regressão} & Preparar massa de teste (TRG1) & \multicolumn{1}{c|}{Mantida} \\ 
    \cline{2-3}
    \multicolumn{1}{|c|}{} & Manter script de regressão (TRG2) & \multicolumn{1}{c|}{Mantida} \\ 
    \cline{2-3}
    \multicolumn{1}{|c|}{} & Executar teste de regressão (TRG3) & \multicolumn{1}{c|}{Mantida} \\ 
    \cline{2-3}
    \multicolumn{1}{|c|}{} & Encerrar teste de regressão (TRG4) & \multicolumn{1}{c|}{Mantida} \\ 
    \hline
    \multicolumn{1}{|c|}{Integração contínua} & Elaborar código (INC1) & \multicolumn{1}{c|}{Mantida} \\ 
    \cline{2-3}
    \multicolumn{1}{|c|}{} & Elaborar script BDD (INC2) & \multicolumn{1}{c|}{Removida} \\ 
    \cline{2-3}
    \multicolumn{1}{|c|}{} & Montar build (INC3) & \multicolumn{1}{c|}{Mantida} \\ 
    \hline
    \multicolumn{1}{|c|}{Teste de desempenho} & Preparar massa de teste (TPE1) & \multicolumn{1}{c|}{Mantida} \\ 
    \cline{2-3}
    \multicolumn{1}{|c|}{} & Manter script de desempenho (TPE2) & \multicolumn{1}{c|}{Mantida} \\ 
    \cline{2-3}
    \multicolumn{1}{|c|}{} & Executar teste de desempenho (TPE3) & \multicolumn{1}{c|}{Mantida} \\ 
    \cline{2-3}
    \multicolumn{1}{|c|}{} & Encerrar teste de desempenho (TPE4) & \multicolumn{1}{c|}{Mantida} \\ 
    \hline
    \end{tabular}
}
\end{table}

As tabelas \ref{tab:4.3} e \ref{tab:4.4} mostram as práticas especificas que foram mantidas, adicionadas ou removidas, com base nos critérios de tomada de decisão mencionados na subseção \ref{sec:melhoriaspropostas}, na análise do MPT.Br e os estudos realizados sobre Metodologia Ágil e Devops. Por fim, uma proposta para o novo processo foi definida na seção \ref{sec:novoprocesso}.
...
\begin{table}[H]
\centering
\caption{Proposta para o novo processo: Readaptação com a junção de práticas especificas e alteração de nível de maturidade.}
\label{tab:4.5}
  \scalebox{0.75}{
\begin{tabular}{|c|c|c|c|c|c|}
\hline
\textbf{\begin{tabular}[c]{@{}c@{}}Nível de \\ Maturidade\\ Atual\end{tabular}} & \textbf{AP}                   & \textbf{PE} & \textbf{Origem}   & \textbf{\begin{tabular}[c]{@{}c@{}}Nível de \\ Maturidade\\ Anterior\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}Práticas \\ Relacionadas\end{tabular}} \\ \hline
\multirow{9}{*}{\textbf{1}}                                                     & \multirow{6}{*}{\textbf{GPT}} & GPT1        & MPT.Br            & 1                                                                           & GPT1, GPT3                                                                \\ \cline{3-6} 
...
\begin{table}[H]
\caption{Estrutura completa proposta para o novo processo.}
\label{tab:4.6}
\scalebox{0.60}{
    ...
    \hline
        \multirow{11}{*}{\centering{1}}&
        \multicolumn{1}{c|}{\multirow{6}{*}{Gerência de projetos de teste (GPT)}}& 
    ...
    \cline{3-3}
        & \multicolumn{1}{c|}{}& 
        Determinar e documentar os riscos do projeto de teste, assim como seu impacto, probabilidade de ocorrência e prioridade de tratamento - GPT5 \\ 
    \cline{3-3}
        & \multicolumn{1}{c|}{}& 
        Monitorar o progresso do projeto com relação ao estabelecido no planejamento e assessorar na realização de pendência - GPT6\\ 
    \cline{2-3}
    ...
    \hline
        \multirow{9}{*}{2}& 
        \multirow{3}{*}{Revisão dos Requisitos (RR)}& 
        Realizar verificação - RR1\\ 
    \cline{3-3}
        & & Relatar e Acompanhar Inconsistências - RR2\\
    \cline{3-3}
        & & Encerrar verificação - RR3\\ 
    \cline{2-3}
...
\textbf{Dependências:} O FreeTest recomenda as seguintes técnicas para a realização dos testes de aceitação: 

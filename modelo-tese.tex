...
\titulo{FreeTest 2.0: Uma Evolução do Método para Melhoria do Processo de Teste de Software em Micro, Pequenas Empresas e Startups Brasileiras}
%\subtitulo{}

\cidade{Goiânia} % Nome da cidade em foi desenvolvido o trabalho
\dia{13} %
\mes{10} % Data da apresenta�ão/defesa do trabalho
...
%\orientadora{Dra. Deller James Ferreira}%
%\orientadoraR{Ferreira, Deller J}%Ferreira, Deller J
